...
public class Wildcards {
    ...
    public static void main(String[] args) {
        ...
        //List<NumberFormatExamples> l5 = new ArrayList<Integer>(); // не компилится
    ...
    // т.к. вне зависимости от того объект с каким типом передадут, его элементы - наследники NumberFormatExamples
